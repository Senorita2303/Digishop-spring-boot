package com.example.digishop.log.service.impl;
...
import com.example.digishop.core.annotation.RequestPostSingleParam;
...
import com.example.digishop.log.service.LogService;
import com.example.digishop.util.Assert;
import com.example.digishop.util.IdUtils;
import com.example.digishop.util.StringUtils;
import com.example.digishop.util.ThrowableUtils;
import com.example.digishop.util.office.ExcelUtils;
...
public class LogServiceImpl extends ServiceImpl<LogMapper, Log> implements LogService {
    ...
    public void saveLog(ProceedingJoinPoint joinPoint, Log logInfo, Object result, Throwable e) {
        try {
            ...
            com.example.digishop.log.annotation.Log aopLog = method.getAnnotation(com.example.digishop.log.annotation.Log.class);
            if (aopLog != null) {
                // 操作日志
