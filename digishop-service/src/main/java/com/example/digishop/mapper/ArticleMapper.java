...
import com.example.digishop.domain.bo.ArticleCountData;
import com.example.digishop.domain.dto.query.ArticleQueryDto;
import com.example.digishop.domain.entity.Article;
import com.example.digishop.domain.vo.ArticleTmpContentVo;
...
public interface ArticleMapper extends BaseMapper<Article> {
	 ...
	 */
	void insertArticlePublishTiming(@Param("id") Long id, @Param("articleId") Long articleId,
			@Param("publishTime") String publishTime, @Param("producerTime") String producerTime);
