package com.example.digishop.core.base;
 ...
 *
 * eg： // @Mapper(componentModel = "spring", unmappedTargetPolicy =
 * ReportingPolicy.IGNORE) // public interface PermissionConverter extends
 * BaseConverter<Permission, PermissionDto, MenuVo> { // }
 *
