package com.example.digishop.util.time;
...
public class DateUtils extends org.apache.commons.lang3.time.DateUtils {
	 ...
	 * 月份中文名称
	 */
	public static final String[] MONTH_ZH = new String[] { "一月", "二月", "三月", "四月", "五月", "六月", "七月", "八月", "九月", "十月",
			"十一月", "十二月" };
	 ...
	 * @return 天数
	 */
	public static int calWorkDayCount(Date startDate, Date endDate, Set<String> workDays, Set<String> restDays)
