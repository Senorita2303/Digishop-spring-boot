package com.example.digishop.util.io;
...
enum FileTypeEnum {
	 ...
	 */
	IMAGE("图片", "image",
			new String[] { "bmp", "dib", "pcp", "dif", "wmf", "gif", "jpg", "tif", "eps", "psd", "cdr", "iff", "tga",
					"pcd", "mpt", "png", "jpeg", "webp" }),

	/**
	 * 文档
	 */
	TXT("文档", "txt", new String[] { "txt", "doc", "pdf", "ppt", "pps", "xlsx", "xls", "docx" }),

	/**
	 * 音乐
	 */
	MUSIC("音乐", "music", new String[] { "mp3", "wav", "wma", "mpa", "ram", "ra", "aac", "aif", "m4a" }),

	/**
	 * 视频
	 */
	VIDEO("视频", "video",
			new String[] { "avi", "mpg", "mpe", "mpeg", "asf", "wmv", "mov", "qt", "rm", "mp4", "flv", "m4v", "webm",
					"ogv", "ogg" }),
