package com.example.digishop.util.ali;
...
/**
 * 阿里云存储配置工具类 阿里云主账号AccessKey拥有所有API的访问权限，风险很高。强烈建议您创建并使用RAM账号进行API访问或日常运维 请登录
...
public class AliYunUtils {
	 ...
	 */
	public static void downloadFile(AliYunOssConfig config, String bucketName, String filePath,
