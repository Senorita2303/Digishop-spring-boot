package com.example.digishop.util.net;
...
/**
 * Local network utility class for obtaining host information, IP addresses, MAC
 * addresses, etc.
 *
 * @author SunTao
 * @since 2024-05-05
...
public final class LocalHostUtils {
	 ...
	 * @throws UnknownHostException if the local host name cannot be resolved to an
	 *                              address
	 */
	...
	/**
	 * Retrieves IP addresses of all network interfaces, excluding loopback,
	 * virtual, and point-to-point addresses.
	 *
