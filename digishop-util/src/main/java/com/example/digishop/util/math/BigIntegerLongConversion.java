package com.example.digishop.util.math;

import java.math.BigInteger;

/**
 * BigIntegerLongConversion is a utility class for converting between BigInteger
 * and long.
 *
 * @author SunTao
 * @since 2024-05-26
...
public class BigIntegerLongConversion {
	/**
	 * Converts a BigInteger to a long. Throws ArithmeticException if the BigInteger
	 * value is out of the range of long.
	 *
	 * @param bigInteger BigInteger to convert, must not be null
	 * @return long value after conversion
	 * @throws ArithmeticException      if the BigInteger value is out of the range
	 *                                  of long
