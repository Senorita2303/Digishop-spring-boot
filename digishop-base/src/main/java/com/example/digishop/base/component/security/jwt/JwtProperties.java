package com.example.digishop.base.component.security.jwt;
...
public class JwtProperties {
	...
	/**
	 * REFRESH_TOKEN 有效时间，单位秒数，要求大于 accessTokenDuration，一般配置为 accessTokenDuration
	 * 的两倍
	 */
	...
	public void setRefreshMinDuration(int refreshMinDuration) {
		...
		if (refreshMinDuration >= accessTokenDuration) {
			throw new IllegalArgumentException(
					"jwt.refresh-token-duration must be less then jwt.refresh-token-duration.");
		}
