package com.example.digishop.base.component.router;

import com.example.digishop.base.domain.bo.RouterInterface;
...
import com.example.digishop.util.collection.ArrayUtils;
...
public class RouterManager {
    ...
    private RouterInterface parseRouter() {
        ...
        for (Map.Entry<RequestMappingInfo, HandlerMethod> m : map.entrySet()) {
            ...
            if (!className.startsWith(digishopProperties.getBasePackage())) {
                // 非系统本身接口，跳过
                continue;
            }
            ...
            com.example.digishop.core.annotation.Router routeInfo = method.getAnnotation(com.example.digishop.core.annotation.Router.class);
            if (routeInfo == null) {
            ...
            // 封装 router
            com.example.digishop.base.domain.entity.Router router = new com.example.digishop.base.domain.entity.Router(routeInfo);
