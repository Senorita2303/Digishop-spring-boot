...
import com.example.digishop.base.component.file.util.LocalStorageUtils;
...
public class LocalFileHandlerService extends BaseFileService {
    ...
    void initVariable() {
        String fileSpec = "/";
        baseUrl = digishopProperties.getFileBaseUrl();
        if (!baseUrl.endsWith(fileSpec)) {
            baseUrl = baseUrl.concat(fileSpec);
        }

        fileUploadPath = digishopProperties.getFileUploadPath();
