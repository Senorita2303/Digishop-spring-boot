...
import com.example.digishop.base.component.security.handler.UserCacheHandler;
import com.example.digishop.base.converter.UserConverter;
import com.example.digishop.base.domain.dto.*;
import com.example.digishop.base.domain.dto.query.UserQueryDto;
import com.example.digishop.base.domain.entity.User;
import com.example.digishop.base.domain.entity.UserPassLog;
import com.example.digishop.base.domain.entity.UserRoleRelation;
import com.example.digishop.base.domain.entity.UserTokenStorage;
import com.example.digishop.base.domain.enums.Gender;
import com.example.digishop.base.domain.vo.UserVo;
import com.example.digishop.base.mapper.UserMapper;
import com.example.digishop.base.mapper.UserPassLogMapper;
import com.example.digishop.base.mapper.UserRoleMapper;
import com.example.digishop.base.mapper.UserTokenStorageMapper;
import com.example.digishop.base.service.UserService;
import com.example.digishop.base.util.Constants;
import com.example.digishop.base.util.GenerateIdUtils;
import com.example.digishop.cache.util.GlobalCacheHelper;
import com.example.digishop.context.constant.TagConstants;
import com.example.digishop.core.base.BaseConst;
import com.example.digishop.core.exception.ServiceException;
import com.example.digishop.core.util.DataValidated;
import com.example.digishop.core.util.SecurityUtils;
import com.example.digishop.encryption.util.RsaUtils;
import com.example.digishop.log.domain.entity.Log;
import com.example.digishop.log.domain.enums.LogType;
import com.example.digishop.log.mapper.LogMapper;
...
public class UserServiceImpl extends ServiceImpl<UserMapper, User> implements UserService {
    ...
    public PageInfo<UserVo> queryUserListByPage(UserQueryDto queryDto) {
        System.out.println(com.example.digishop.context.Context.get(TagConstants.SYS_CODE_TAG));
        System.out.println(com.example.digishop.context.Context.get(TagConstants.APP_CODE_TAG));
        System.out.println(com.example.digishop.context.Context.get(TagConstants.DEPLOY_AREA_TAG));
        System.out.println(com.example.digishop.context.Context.get(TagConstants.DEPLOY_CENTER_TAG));
        System.out.println(com.example.digishop.context.Context.get(TagConstants.DEPLOY_UNIT_TAG));
        System.out.println(com.example.digishop.context.Context.get(TagConstants.DEPLOY_IP_TAG));
        System.out.println(com.example.digishop.context.Context.get(TagConstants.DEPLOY_CODE_TAG));
        System.out.println(com.example.digishop.context.Context.get("conversion-id"));
        System.out.println(com.example.digishop.context.Context.get("User-Id"));
        queryDto.checkPage();
