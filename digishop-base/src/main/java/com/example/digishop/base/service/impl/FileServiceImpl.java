...
import com.example.digishop.base.component.file.FileHandler;
import com.example.digishop.base.component.file.FileTypeHandler;
import com.example.digishop.base.component.file.model.FileInfo;
import com.example.digishop.base.component.file.model.FileUploadType;
import com.example.digishop.base.domain.bo.storage.AliYunConfig;
import com.example.digishop.base.domain.bo.storage.BaseStorageConfig;
import com.example.digishop.base.domain.bo.storage.LocalConfig;
import com.example.digishop.base.domain.bo.storage.QiNiuYunConfig;
import com.example.digishop.base.domain.dto.query.FileQueryDto;
import com.example.digishop.base.domain.entity.Dict;
import com.example.digishop.base.domain.entity.File;
import com.example.digishop.base.domain.vo.ActiveStorageTypeVo;
import com.example.digishop.base.mapper.DictMapper;
import com.example.digishop.base.mapper.FileMapper;
import com.example.digishop.base.service.FileService;
import com.example.digishop.base.util.GenerateIdUtils;
import com.example.digishop.core.base.BaseConst;
import com.example.digishop.core.config.properties.DigishopProperties;
import com.example.digishop.core.enums.ResultCode;
import com.example.digishop.core.exception.BadConfigurationException;
...
public class FileServiceImpl extends ServiceImpl<FileMapper, File> implements FileService {
	...
	private final DigishopProperties digishopProperties;
	...
	public BaseStorageConfig getConfigInfo(Integer storageType) {
		...
		if (FileTypeHandler.LOCAL.getType() == storageType) {
			...
			config.setDomain(digishopProperties.getFileBaseUrl());
			config.setUploadFolder(digishopProperties.getFileUploadPath());
			return config;
