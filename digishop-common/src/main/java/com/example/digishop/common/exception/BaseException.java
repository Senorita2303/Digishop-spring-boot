package com.example.digishop.common.exception;
...
public abstract class BaseException extends RuntimeException {
	...
	/**
	 * Overrides getMessage() method to return a formatted message using
	 * MusesExceptionUtil.
	 *
	 ...
	 *
	 * @return the most specific cause, or this exception if no more specific cause
	 *         is found
	 */
	...
	/**
	 * Checks whether this exception contains an instance of the specified exception
	 * type within its cause chain.
	 *
	 * @param exType the exception type to look for
	 * @return true if an instance of the specified exception type is found, false
	 *         otherwise
	 */
