package com.example.digishop.context.properties;
...
import com.example.digishop.util.net.LocalHostUtils;

/**
 * Header parameters for configuring caller system code, application code, and
 * deployment information.
 * <p>
 * This class provides functionality to configure caller system code,
 * application code, and deployment information, including deployment region,
 * deployment center/room, deployment server address, and deployment unit.
 * </p>
 *
 * @since 2024-05-05
 * @author SunTao
...
public class HeaderProperties implements Serializable, InitializingBean, EnvironmentAware {
	...
	/**
	 * Sets the caller application code. If appCode is null, it defaults to the
	...
	public static class Deploy {
		...
		/**
		 * Sets the deployment unit. If deployUnit is less than 0 or greater than 17, an
