package com.example.digishop.context.exception;

import com.example.digishop.common.exception.BaseException;

/**
 * The Context exceptions in the framework. Extends RuntimeException to allow
