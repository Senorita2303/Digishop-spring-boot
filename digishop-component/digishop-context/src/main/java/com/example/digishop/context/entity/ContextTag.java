package com.example.digishop.context.entity;
 ...
 *
 * This class encapsulates properties related to a context tag: - tagName: Name
 * of the tag. - tagValue: Value associated with the tag.
 *
 * @author SunTao
 * @since 2024-05-22
 */
