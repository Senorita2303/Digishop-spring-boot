 ...
 *
 * This class provides utility methods for accessing beans and environment
 * properties from the Spring ApplicationContext.
 *
 * @author SunTao
 * @since 2024-04-30
 */
...
public class SpringContextUtil {
	...
	/**
	 * Get a property from the environment by key, with a default value if the
	...
	/**
	 * Get a property from the environment by key and convert it to a specified
	 * type.
	 *
	 * @param key   The key of the property
	...
	/**
	 * Get a property from the environment by key, convert it to a specified type,
	 ...
	 * @param defaultValue The default value if the property is not found
	 * @param <T>          The type of the property value
	 * @return The property value converted to the specified type, or the default
	 *         value if not found
	 */
