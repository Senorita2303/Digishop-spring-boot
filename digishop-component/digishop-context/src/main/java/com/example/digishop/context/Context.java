...
/**
 * Utility class for interacting with CoreContext. Provides static methods to
 * get and put context tags.
 *
 * @author SunTao
 * @since 2024-07-02
 */
...
public class Context {
	...
	/**
	 * Retrieves the current CoreContext instance from the thread-local context
	 * holder.
	 *
