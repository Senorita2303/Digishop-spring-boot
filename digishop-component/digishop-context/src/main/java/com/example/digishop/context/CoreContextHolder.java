package com.example.digishop.context;

import com.example.digishop.context.constant.TagConstants;
import com.example.digishop.context.entity.ContextTag;
...
import com.example.digishop.context.util.SpringContextUtil;

/**
 * Manages a thread-local instance of {@link CoreContext}. Provides methods to
 * get, set, and remove the context for the current thread. Uses
 * {@link ThreadLocal} for thread safety.
 *
 * @author SunTao
 * @since 2024-07-02
 */
class CoreContextHolder {
	...
	/**
	 * Retrieves the current thread's {@link CoreContext} instance. Creates a new
	 * instance if none exists for the current thread.
	 *
